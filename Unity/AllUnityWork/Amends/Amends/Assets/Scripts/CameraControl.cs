...
public class CameraControl : MonoBehaviour
{
    ...
    //float playerSpeedCameraSizeModifier = .25f;
    ...
    void LateUpdate()
    {
        if (!isPaused)
        {
            ...
            //GetComponent<Camera>().orthographicSize = cameraBaseSize + playerSpeedCameraSizeModifier * player.GetComponent<CharacterController>().Velocity.magnitude;
        }
    }
