...
public static class Utilities
{
    ...
    /// <summary>
    /// Gets the desired Z value for the direction we want to look at. (if object isn't oriented pointing right, will need to rotate direction accordingly)
    /// </summary>
    /// <param name="direction">The direction to look</param>
    /// <returns>The z value for the euler angle</returns>
    public static float EulerAnglesLookInDirection(Vector2 direction)
    {
        return EulerAnglesLookAt(Vector2.right, direction);
    }
